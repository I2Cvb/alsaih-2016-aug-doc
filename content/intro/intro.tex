...
\begin{figure}
\centering
        \subfloat[\gls{dme}-case]{\includegraphics[width = 0.2\textwidth, height = 0.15\textheight]{dme_case}}\hfill
        \subfloat[normal-case]{\includegraphics[width = 0.2\textwidth, height = 0.15\textheight]{normal_case2}}
